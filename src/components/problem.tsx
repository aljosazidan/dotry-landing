...
/* Premium phone frame comparison: "Online" vs "Reality" */
function ComparisonVisual() {
  return (
    <div className="relative flex items-center justify-center gap-4 sm:gap-6 lg:gap-8">
      {/* Ambient glow behind entire visual */}
      <div className="pointer-events-none absolute inset-0 -m-10 rounded-full bg-rose/5 blur-[60px]" />

      {/* LEFT: What you see online - pristine product card */}
      <motion.div
      ...
      >
          ...
          <div className="px-3 pb-4 sm:px-4">
            ...
            <div className="relative mx-auto flex h-28 w-full items-center justify-center rounded-xl bg-gradient-to-b from-white/[0.04] to-transparent sm:h-36">
              ...
              <motion.div
                ...
                className="absolute right-3 top-3 text-[10px] text-white/40 sm:right-4"
              >
                ✦
              </motion.div>
            </div>
        ...
        <div className="mt-4 text-center">
          <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/25 sm:text-[11px]">
            Im Shop
          </span>
        </div>
        ...
        <motion.div
          ...
          className="absolute -left-2 -top-2 flex h-7 w-7 items-center justify-center rounded-full bg-emerald-500/90 text-xs font-bold text-white shadow-lg shadow-emerald-500/30"
        >
          ✓
        </motion.div>
      </motion.div>

      {/* CENTER: Arrow / mismatch indicator */}
      <motion.div
      ...
      >
        <div className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/[0.05] backdrop-blur-sm sm:h-14 sm:w-14">
          <span className="text-2xl font-light text-rose sm:text-3xl">≠</span>
        </div>
      </motion.div>

      {/* RIGHT: What actually arrives - disappointed reality */}
      <motion.div
        initial={{ opacity: 0, y: 20, rotateY: -5 }}
        whileInView={{ opacity: 1, y: 0, rotateY: 0 }}
        viewport={{ once: true }}
        ...
        className="relative z-10"
      >
        {/* Phone frame with red tint border */}
        <div className="w-[150px] overflow-hidden rounded-[20px] border border-red-500/20 bg-gradient-to-b from-white/[0.06] to-white/[0.02] shadow-2xl shadow-red-900/20 sm:w-[180px]">
          ...
          <div className="px-3 pb-4 sm:px-4">
                ...
                <div className="h-20 w-20 rounded-full bg-gradient-to-br from-[#F5D0C5]/20 to-[#E8B4A8]/10 sm:h-24 sm:w-24">
                  <div className="absolute inset-1 rounded-full bg-gradient-to-br from-[#F5D0C5]/15 to-[#DEB5A8]/10">
                    ...
                    <motion.div
                      ...
                      className="mx-auto mt-1.5 h-2.5 w-6 rounded-full bg-[#9E6B5A]/50 sm:w-7"
                    />
                  </div>
                </div>
                {/* Sad indicator */}
            ...
            {/* Color comparison - showing mismatch */}
            <div className="mt-3 flex items-center gap-2">
              <div className="relative">
        ...
        >
          <motion.div
            ...
            transition={{ duration: 2, repeat: Infinity }}
            className="flex h-7 w-7 items-center justify-center rounded-full bg-red-500 text-xs font-bold text-white shadow-lg shadow-red-500/40"
          >
            ✕
          </motion.div>
        </motion.div>
...
export function Problem() {
  return (
    <section className="relative overflow-hidden bg-dark py-28 text-white sm:py-32 lg:py-40">
      ...
      {/* Glows */}
      <div className="pointer-events-none absolute left-1/4 top-0 h-[500px] w-[700px] -translate-y-1/2 rounded-full bg-rose/8 blur-[150px]" />
      <div className="pointer-events-none absolute bottom-0 right-1/4 h-[300px] w-[400px] translate-y-1/2 rounded-full bg-red-500/5 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          {/* Two-column: stat left, visual right */}
          <div className="flex flex-col items-center gap-16 lg:flex-row lg:items-center lg:gap-24">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <motion.p
                variants={fadeUpStagger}
                className="mt-3 max-w-md text-base leading-relaxed text-white/50 sm:text-lg"
              >
              ...
              <motion.div
                variants={fadeUpStagger}
                className="mt-6 h-px w-16 bg-gradient-to-r from-rose/50 to-transparent lg:mx-0 mx-auto"
              />

              <motion.h2
                variants={fadeUpStagger}
                className="mt-6 font-serif text-2xl font-medium leading-tight tracking-tight sm:text-3xl lg:text-4xl"
              >
              ...
              <motion.p
                variants={fadeUpStagger}
                className="mt-6 text-lg font-medium text-rose"
              >
